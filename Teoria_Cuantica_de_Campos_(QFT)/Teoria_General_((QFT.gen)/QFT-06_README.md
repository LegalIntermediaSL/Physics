# [QFT-06] Teoria Cuantica de Campos

Bienvenido a la sección de **Teoria Cuantica de Campos**. Aquí encontrarás tratados teóricos detallados y de nivel de postgrado sobre los fundamentos matemáticos y físicos de esta disciplina (Régimen Perturbativo y No-Perturbativo).

## Índice de Contenidos

- 📄 **[Anomalías Cuánticas y Simetría Quiral](./Anomalias_Cuanticas_ABJ.md)**
- 📄 **[Diagramas de Feynman y Electrodinámica Cuántica (QED)](./Diagramas_de_Feynman_y_QED.md)**
- 📄 **[La Ecuación de Dirac y el Descubrimiento de la Antimateria](./Ecuacion_Dirac_y_Antimateria.md)**
- 📄 **[Lattice QCD: La Cromodinámica en el Retículo](./Lattice_QCD_y_Confinamiento.md)**
- 📄 **[Domando el Infinito: Renormalización](./Renormalizacion_y_Grupo_de_Renormalizacion.md)**
