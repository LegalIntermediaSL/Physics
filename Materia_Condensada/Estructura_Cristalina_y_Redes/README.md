...
- **Cursos:** MIT OCW 8.231 (Physics of Solids), Cursos de Cristalografía en Coursera, NPTEL Solid State Physics.
- **Artículos/Simulaciones:** "Crystal Lattice" simulation en PhET Interactive Simulations, VESTA (Visualization for Electronic and STructural Analysis), y los primeros capítulos de Kittel (Introduction to Solid State Physics).
