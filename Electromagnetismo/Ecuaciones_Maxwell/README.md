...
- [Perimeter Institute: Gauge Theories and Electrodynamics](https://pirsa.org/) - Expresiones formales y seminarios que analizan las ecuaciones de Maxwell dentro del marco del álgebra exterior moderna y simetrías U(1).
- [Max Planck Institute for the Science of Light Seminars](https://mpl.mpg.de/news-events/events/) - Charlas revolucionarias sobre fotónica topológica e interacciones electrodinámicas extremas inducidas por pulsos attosegundo ultracortos.
- [Harvard Quantum Optics and AMO Seminars](https://www.physics.harvard.edu/events/amo) - Ciclos de investigación profundizando en la electrodinámica cuántica y la cuantización explícita del tensor electromagnético estocástico de campo.
- [Nature Photonics: Spatiotemporal Metamaterials](https://www.nature.com/nphoton/) - Reporta manipulaciones experimentales exóticas donde la permitividad modulada ultrarrápida altera irreversiblemente el tensor electromagnético violando reciprocidad.
- [Reviews of Modern Physics: The Aharonov-Bohm Effect and Maxwell's Equations](https://journals.aps.org/rmp/) - Resumen histórico y matemático fundamental de la transición entre la visión de vectores de fuerza y la visión topológica de los cuadripotenciales en espacios de gauge conexos.
- [PRL: Observation of Chiral Electrodynamics in Dirac Semimetals](https://journals.aps.org/prl/) - Evidencia reciente sobre modificaciones asombrosas inducidas sobre las Ecuaciones de Maxwell convencionales macroscópicas al propagarse campos acoplados resonantes por nuevos materiales topológicos condensados.
